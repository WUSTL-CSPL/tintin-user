...
bar_width = 0.2
fig, (ax1, ax2) = plt.subplots(2, 1, figsize=(13, 2.9))
plt.subplots_adjust(left=0.05, right=0.98, top=0.95, bottom=0.24)
...
ax2.set_xticklabels(workloads, rotation=25) #, ha='right', position=(0, 0.05))
